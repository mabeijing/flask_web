...
engine = create_engine("mysql+pymysql://root:root123@localhost/tms?charset=utf8mb4", echo=False)
...
class TBRequest(Model):
    ...
    METHOD = Column(Enum('POST', 'GET', 'PUT', 'UPDATE', 'DELETE'), nullable=False, comment='请求方法')
